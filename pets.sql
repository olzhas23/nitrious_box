...
*/
/*ALTER USER olzhas WITH PASSWORD 'admin';
GRANT SELECT ON ALL TABLES IN SCHEMA public TO olzhas;
GRANT SELECT ON ALL SEQUENCES IN SCHEMA public TO olzhas;

CREATE USER backup_user  WITH ENCRYPTED PASSWORD 'password';

GRANT CONNECT ON DATABASE pets to backup_user;
\c pets
GRANT USAGE ON SCHEMA public to backup_user; 
GRANT SELECT ON ALL SEQUENCES IN SCHEMA public TO backup_user;
GRANT SELECT ON ALL TABLES IN SCHEMA public TO backup_user;

GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO olzhas;*/
